const foods = [
    {
        name: "Beef",
        creation: "https://www.themealdb.com/images/category/beef.png",
    ...
    {
        name: "Chicken",
        creation: "https://www.themealdb.com/images/category/chicken.png",
    ...
    {
        name: "Dessert",
        creation:"https://www.themealdb.com/images/category/dessert.png",
    ...
    {
        name: "Pork",
        creation: "https://www.themealdb.com/images/category/pork.png",
    ...
    {
        name: "Seafood",
        creation: "https://www.themealdb.com/images/category/seafood.png",
    ...
    {
        name: "Vegan",
        creation: "https://www.themealdb.com/images/category/vegan.png",
        description:"Veganism is both the practice of abstaining from the use of animal products, particularly in diet, and an associated philosophy that rejects the commodity status of animals.[b] A follower of either the diet or the philosophy is known as a vegan (pronounced \/'vi?g?n\/ VEE-g?n). Distinctions are sometimes made between several categories of veganism. Dietary vegans (or strict vegetarians) refrain from consuming animal products, not only meat but also eggs, dairy products and other animal-derived substances. The term ethical vegan is often applied to those who not only follow a vegan diet but extend the philosophy into other areas of their lives, and oppose the use of animals for any purpose. Another term is environmental veganism, which refers to the avoidance of animal products on the premise that the harvesting or industrial farming of animals is environmentally damaging and unsustainable."
    },

    {
        name:"Miscellaneous",
        creation: "https://www.themealdb.com/images/category/miscellaneous.png",
        description: "General foods that don't fit into another category",
    },

    {
        name: "Lamb",
        creation: "https://www.themealdb.com/images/category/lamb.png",
    ...
    {
        name: "Pasta",
        creation: "https://www.themealdb.com/images/category/pasta.png",
    ...
    {
        name: "Side",
        creation: "https://www.themealdb.com/images/category/side.png",
    ...
    {
        name: "Starter",
        creation: "https://www.themealdb.com/images/category/starter.png",
    ...
    {
        name: "Vegetarian",
        creation: "https://www.themealdb.com/images/category/vegetarian.png",
